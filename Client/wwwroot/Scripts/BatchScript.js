...
$(document).ready(function () {
    //Load Data Table
    table = $('#Batches').DataTable({ //Nama table pada index
        "ajax": {
            url: "/Batches/LoadBatch", //Nama controller/fungsi pada index controller
            type: "GET",
            dataType: "json",
            dataSrc: ""
        },
...
function Edit() {
    ...
    $.ajax({
        ...
        if (result.statusCode === 200) {
            ...
            Swal.fire('Error', 'Failed to Edit Batch', 'error');
            ShowModal();
        }
    });
}
